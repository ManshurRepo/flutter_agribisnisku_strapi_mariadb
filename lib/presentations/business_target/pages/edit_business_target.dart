...
class EditBusinessPage extends StatefulWidget {
  ...
  const EditBusinessPage({Key? key, required this.business})
      : super(key: key);
...
class _EditBusinessPageState extends State<EditBusinessPage> {
  ...
  void initState() {
    super.initState();
    final Attributes attributes = widget.business.attributes;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Edit Business Targets',
              ...
              onPressed: () async {
                ...
                try {
                  await BusinessRemoteDataSource()
                      .editTask(widget.business.id, newModel);
                  Navigator.pushReplacement(context,
                      MaterialPageRoute(builder: (context) {
                    return const EditBusinessSuccessPage();
                  }));
                } catch (e) {
